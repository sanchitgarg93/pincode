...
<img src="images/main_logo.gif" width="310" height="61" alt="" />
	...
	<div class="main_menu">
		<!--
			<div class="fl"><img width="7" height="39" alt="" src="images/main_menu_left.jpg">
			</div>
		-->
        <div class="fl">
        ...
        <!--
			<div class="fr"><img width="7" height="39" alt="" src="images/main_menu_right.jpg">
			</div>
		-->
    </div>
<!--
...
-->
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="352"> <!-- No effect on changing its width  -->
				<table width="954px" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							<img src="images/search_top.gif" alt="" width="352" height="4" />
						</td>
					</tr>
					<tr>
						<td align="left" valign="top" class="serch_middle">
					<table width="954px" border="1" cellspacing="0" cellpadding="0">
						<tr>
							<td style="padding-left:10px;">
								<img src="images/search_icon.gif" alt="" width="14" height="15" />
								<span class="black_font">&nbsp;Search Pin Codes</span>
							</td>
						</tr>
						<tr>
							<td>
								<img src="images/serch_line.gif" alt="" width="350" height="1" />
							</td>
						</tr>
						<tr> <!-- Main Table Begins -->
						<td valign="top">
...
{?>
  ...
  <option value="">Select this to view all post office names<!--Select State/District to see 1st Alphabet List--></option>
		...
		<option>z</option>
              ...
              <tr>
                <td>
					<img src="images/search_bottom.gif" alt="" width="352" height="5" />
				</td>
              </tr>
            </table>
			</td>
